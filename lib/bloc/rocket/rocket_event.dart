...
import 'package:spacex/bloc/rocket/index.dart';
...
abstract class RocketEvent extends Equatable {
  ...
  final RocketRepository _roadsterRepository = RocketRepository(apiGateway: GetIt.instance<ApiGateway>());
}

class LaunchInitial extends RocketEvent {
  @override
  Stream<RocketState> loadAsync({RocketState currentState, RocketBloc bloc}) async* {
    try {
      ...
      developer.log('$_', name: 'LoadRocketEvent', error: _, stackTrace: stackTrace);
