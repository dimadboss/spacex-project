...
import 'package:spacex/bloc/roadster/index.dart';
import 'package:spacex/resources/repository/roadster_repository.dart';
...
abstract class RoadsterEvent extends Equatable {
  ...
  Stream<RoadsterState> loadAsync({RoadsterState currentState, RoadsterBloc bloc});
...
class LaunchInitial extends RoadsterEvent {
  ...
  @override
  Stream<RoadsterState> loadAsync({RoadsterState currentState, RoadsterBloc bloc}) async* {
    try {
      ...
      final model = await _roadsterRepository.fetchRoadster();
