...
import 'package:spacex/ui/widgets/image_slider.dart';
              ...
              slivers: <Widget>[
                SliverAppBar(
                  ...
                  flexibleSpace: PhotoPageView(
                    imageList: model.flickrImages.map((e) => e.toString()).toList(),
                  ),
                ),
                SliverList(
                  delegate: SliverChildListDelegate(
                    [
                      ...
                      Divider(height: 0),
                      SListTile("First flight on", "${model.firstFlight}"),
                      Divider(height: 0),
                      ...
                      SListTile("Launch payload mass", "${model.launchPayloadMass.kg} Kg"),
                      Divider(height: 0),
                      SListTile("Return payload mass", "${model.returnPayloadMass.kg} Kg"),
                      Divider(height: 0),
                      SListTile("Launch payload volume", "${model.launchPayloadVol.cubicMeters} cubic meter"),
                      Divider(height: 0),
                      SListTile("Return  payload mass", "${model.returnPayloadVol.cubicMeters} cubic meter"),
                      Divider(height: 0),
